...
import i18n, { reloadTranslations } from '../i18n/index';
    ...
    try {
      ...
      if (!response.success) {
        if (response.isNetworkError) {
          ...
          Alert.alert(t('common:noInternetConnection'), t('common:noInternetMessage'), [
            { text: t('common:ok') },
          ]);
          setLoading(false);
          return;
    ...
    <SafeAreaView style={[styles.container, { backgroundColor: appColors.background }]}>
      ...
      >
        <View style={styles.content}>
          <View style={styles.logoContainer}>{/* ... logo code ... */}</View>
          ...
          <View style={styles.formContainer}>
            ...
            >
              <View style={styles.exampleContainer}>
                <Text style={[styles.exampleLabel, { color: appColors.text }]}>
                  {/* مثال لرقم الهاتف */}
                  {i18n.getResourceBundle(i18n.language, 'auth')?.phoneExample ||
                    'مثال: +9647XXXXXXXX'}
                </Text>
            ...
            >
              <Text style={[styles.forgotPasswordText, { color: appColors.primary }]}>
                {/* نسيت كلمة المرور */}
                {i18n.getResourceBundle(i18n.language, 'auth')?.forgotPassword ||
                  'نسيت كلمة المرور؟'}
              </Text>
            </TouchableOpacity>
