...
const ProfileMenuItem = ({ icon, title, onPress, appColors, isRTL }: ProfileMenuItemProps) => (
  ...
  >
    <View style={[styles.menuItemContent, { flexDirection: isRTL ? 'row-reverse' : 'row' }]}>
      <View style={[styles.menuItemIcon, { backgroundColor: appColors.primary + '15' }]}>
...
export default function ProfileScreen() {
  ...
  const loadUserStats = async () => {
    try {
      ...
      if (__DEV__) {
        console.log(
          'Dev Only - Loading user stats with token:',
          userToken ? `${userToken.substring(0, 10)}...` : 'No token',
        );
      }
      ...
      if (myAdsResponse.success && myAdsResponse.data) {
        ...
        if (
          myAdsResponse.message?.includes('token') ||
      ...
      if (__DEV__) {
        ...
        if (error.response) {
          console.error(
            `Dev Only - Error status: ${error.response.status}, Error data:`,
            error.response.data,
          );
        }
      }
          ...
          >
            <Text
              style={[
                ...
                { color: appColors.buttonText, fontFamily: 'Cairo-Bold' },
              ]}
            >
              {t('login', { ns: 'common' })}
            </Text>
          ...
          >
            <Text
              style={[
                ...
                { color: appColors.primary, fontFamily: 'Cairo-Bold' },
              ]}
            >
      ...
      >
        ...
        <View style={[styles.header, { backgroundColor: appColors.primary }]}>
          ...
          <Text
            style={[
              styles.userInfo,
              { color: 'rgba(255, 255, 255, 0.8)', fontFamily: 'Cairo-Regular' },
            ]}
          >
          ...
          <Text
            style={[
              styles.userInfo,
              { color: 'rgba(255, 255, 255, 0.8)', fontFamily: 'Cairo-Regular', marginBottom: 16 },
            ]}
          >
          ...
          >
            <Text
              style={[
                ...
                { color: appColors.primary, fontFamily: 'Cairo-Medium' },
              ]}
            >
              {t('edit', { ns: 'common' })}
            </Text>
        ...
        >
          <Text
            style={[styles.logoutText, { color: appColors.danger, fontFamily: 'Cairo-Medium' }]}
          >
            {t('logout', { ns: 'common' })}
          </Text>
          <Ionicons
